...
const Dashboard = () => {
  ...
  const features = [
    ...
    { title: "Location Tracking", icon: <HiOutlineLocationMarker />, bgColor: "bg-gradient-to-r from-cyan-500 to-cyan-400", url: "/location-tracking" },
    { title: "AI Safety Assessment", icon: <HiOutlineLightBulb />, bgColor: "bg-gradient-to-r from-teal-500 to-teal-400", url: "/safety-assessment" },
    { title: "Community Safety", icon: <HiOutlineUsers />, bgColor: "bg-gradient-to-r from-purple-500 to-purple-400", url: "/community-safety" },
    { title: "Emergency Response", icon: <HiOutlineExclamationTriangle />, bgColor: "bg-gradient-to-r from-red-500 to-red-400", url: "/emergency-response" },
    { title: "Travel Safety", icon: <HiOutlineGlobe />, bgColor: "bg-gradient-to-r from-indigo-500 to-indigo-400", url: "/travel-safety" },
